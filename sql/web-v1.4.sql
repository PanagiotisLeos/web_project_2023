...
-- Χρόνος δημιουργίας: 14 Αυγ 2023 στις 16:22:44
...
(3, 4.8, 21, 194, 111, 'ΝΑΙ', '2023-08-11'),
(4, 7, 21, 995, 111, 'ΝΑΙ', '2023-08-11'),
(8, 15, 21, 458, 111, 'ΝΑΙ', '2023-08-14'),
(9, 2, 21, 1020, 99, 'ΟΧΙ', '2023-08-14'),
(20, 1, 21, 814, 99, 'ΝΑΙ', '2023-08-14');
...
INSERT INTO `user` (`user_id`, `username`, `email`, `password`, `is_admin`, `score`) VALUES
(1, 'test', 'info@test.gr', 'test', 0, NULL),
(21, 'Panagiotis', 'leospanagiotis@gmail.com', '*84CC92B25B13F4CEA01DF913B6215B83438B2921', 0, 15),
(30, 'admin', 'admin@test.gr', '*B3D0CD604CE2C2112084799DEF9DF796B789AEA1', 1, NULL),
(31, 'vaslis', 'leosvasilis@gmail.com', '*51B8DF371278FD677D923013F0759878ECED408D', 0, NULL);
...
--
ALTER TABLE `user`
  MODIFY `user_id` smallint(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=32;
