...
{
    $t=mysqli_query($conn,"SELECT store.id as store_id,store.name AS store_name, product.name AS product_name,category.name as category_name,offers.stock, offers.price , latitude , longitude
    FROM store 
